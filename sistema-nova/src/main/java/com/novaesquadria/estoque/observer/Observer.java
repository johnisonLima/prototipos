...
/* 
 Este código define uma interface chamada Observer no pacote main.java.com.novaesquadria.estoque.observer. A interface Observer possui um único método, atualizar, que recebe um objeto do tipo Estoque como parâmetro.
